...
@section('page_title', 'Edit Dudi')

@section('breadcrumb')
    @php
    $breadcrumbs = [['Dudi', route('prodi.dudi.index')], ['Detail', route('prodi.dudi.show', ['id' => $data['obj']->id])], 'Edit'];
    @endphp
    @include('layouts.parts.breadcrumb', ['breadcrumbs' => $breadcrumbs])
@endsection

@section('content')
    <form action="{{ route('prodi.dudi.update', ['id' => $data['obj']->id]) }}" method="POST" autocomplete="off"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-gorup mb-3">
                            ...
                            <textarea id="address" name="address" class="form-control" required>{{ $data['obj']->address }}</textarea>
                        </div>
                        <div class="form-gorup mb-3">
