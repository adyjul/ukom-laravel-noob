        ...
        <div class="col-md-12 mb-3">
            <div class="js-wizard-simple block  shadow border-10px">
                ...
                <ul class="nav nav-tabs nav-tabs-block nav-justified {{ $status }}" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  h-100 d-flex justify-content-center align-items-center"
                            href="#wizard-simple-step5" data-toggle="tab">Kolaborasi Proposal</a>
                    </li>
                </ul>
                <!-- END Step Tabs -->
                ...
                <div class="block-content block-content-full tab-content px-md-5" style="min-height: 300px;">
                    ...
                    <div class="tab-pane" id="wizard-simple-step5" role="tabpanel">
                        <div class="ml-auto card-tools mb-3">
                            <a class="btn btn-primary" id="tambah_kolaborator" data-toggle="modal" data-target="#modal-data-kolaborasi"><i
                                    class="fa fa-plus" aria-hidden="true"></i> Tambah</a>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-vcenter" id="table-proposal-kolaborasi"
                                style="width: 100% !important;">
                                <thead>
                                    <tr>
        ...
        <div class="col-md-12">
            <div class="block block-bordered" id="block-proposal-registration-config">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Pengaturan Deskripsi Kelas CoE</h3>
                ...
                <div class="block-content">
                    <form action="{{ route('prodi.proposal.ajaxupdate.deskripsi.proposal') }}" method="POST"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="number" class="form-control" id="quota" name="quota"
                                    ...
                                    value="{{ optional($data['obj']['class_description'])['kuota'] }}" required>
                                <input type="hidden" class="form-control" id="proposal_id" name="proposal_id"
                                    value="{{ $data['obj']->id }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-daterange input-group" data-date-format="dd-mm-yyyy" data-week-start="1"
                                    ...
                                    <input type="text" class="form-control" id="mahasiswa_registration_date_start"
                                        ...
                                        data-autoclose="true" data-today-highlight="true"
                                        value="{{ optional(optional($data['obj']['class_description'])['pendaftaran'])['tgl_awal'] }}" required>
                                    ...
                                    <input type="text" class="form-control" id="mahasiswa_registration_date_end"
                                        ...
                                        data-autoclose="true" data-today-highlight="true"
                                        value="{{ optional(optional($data['obj']['class_description'])['pendaftaran'])['tgl_akhir'] }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-daterange input-group" data-date-format="dd-mm-yyyy" data-week-start="1"
                                    data-autoclose="true" data-today-highlight="true">
                                    <input type="text" class="form-control" id="mahasiswa_activity_date_start"
                                        name="mahasiswa_activity_date_start" placeholder="Dari" data-week-start="1"
                                        data-autoclose="true" data-today-highlight="true"
                                        value="{{ optional(optional($data['obj']['class_description'])['kegiatan'])['tgl_awal'] }}" required>
                                    <div class="input-group-prepend input-group-append">
                                        <span class="input-group-text font-w600">
                                            <i class="fa fa-fw fa-arrow-right"></i>
                                        </span>
                                    ...
                                    <input type="text" class="form-control" id="mahasiswa_activity_date_end"
                                        name="mahasiswa_activity_date_end" placeholder="Sampai" data-week-start="1"
                                        data-autoclose="true" data-today-highlight="true"
                                        value="{{ optional(optional($data['obj']['class_description'])['kegiatan'])['tgl_akhir'] }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label" for="quota">Biaya Pendaftaran</label>
                            <div class="col-md-8">
                                <input type="text" name="biaya" id="biaya" class="form-control currency" placeholder="Biaya Daftar"
                                    value="{{ number_format(optional($data['obj']['class_description'])['biaya'], 0, '', '.') }}"
                                    data-prefix="Rp ">
                                <input type="hidden" class="form-control" id="proposal_id" name="proposal_id"
                                    value="{{ $data['obj']->id }}" required>
                            </div>
...
{{-- Modal Kolaborasi Proposal --}}

@push('modals')
<div class="modal fade" id="modal-data-kolaborasi" tabindex="-1" role="dialog" data-backdrop="static"
aria-labelledby="modal-block-popout" aria-hidden="true">
<div class="modal-dialog modal-dialog-popout modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
    <div class="modal-content">
        <div class="block block-rounded block-themed block-transparent mb-0">
            <div class="block-header bg-primary-dark">
                <h3 class="block-title">Tambah kolaborator</h3>
                <div class="block-options">
                    <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
                        <i class="fa fa-fw fa-times"></i>
                    </button>
            ...
            <div class="block-content font-size-sm">
                ...
                <form action="{{ route('prodi.proposal.ajaxstore.kolaborator') }}" method="post" id="form_kolaborator">
                    <div class="block-content font-size-sm">
                        <input type="hidden" name="proposal_id" value="{{ $data['obj']['id'] }}" id="proposal_id_kolabortor">
                        <div class="form-gorup mb-3">
                            <label class="w-100" for="prodi_name">Pilih Kolaborator<span
                                    class="text-danger">*</span></label>
                            <select class="prodi_name w-100" id="user_name" name="user_id">
                            </select>
                        </div>
                        <div class="">
                            <button class="btn btn-primary mr-auto mb-3" type="submit">Simpan</button>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            $('#table-proposal-kolaborasi').DataTable({
                processing: true,
                serverSide: false,
                ajax: "{{ route('prodi.proposal.ajaxdatatable.kolaborator', ['proposal_id' => $data['obj']['id']]) }}",
                columns: [
                    {
                        data: 'user.name',
                        orderable: false,
            ...
            select('user_name', '{{ route('prodi.proposal.ajax.select2.kolaborator') }}',1);
            ...
            $(document).on('submit', '#form_kolaborator', function(e) {
                e.preventDefault();
                var url = $(this).attr('action');
                var proposal_id = "{{ $data['obj']['id'] }}";
                loader.show();
                fetch(url, {
                        method: 'POST',
                        headers: {
                    ...
                    .then(result => {
                        if (result.code == 200) {
                            ...
                            $('#table-proposal-kolaborasi').DataTable().ajax.reload();
                        } else {
                            throw result.message
                        }
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            const $form_update_proposal_registration = $("#form-update-proposal-registration"), $block_proposal_registration_config = $("#block-proposal-registration-config");
